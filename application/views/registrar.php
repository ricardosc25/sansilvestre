...
<div class="main container">
    ...
    <!-- AVISO DE DONACIÓN POR INSCRIPCIÓN -->
   <div class="alert alert-success">
        <strong>LA INSCRIPCIÓN TIENE UN COSTO DE $40.000, </strong>las categorías y premios los puedes ver en el siguiente link <a href="<?php echo base_url(); ?>lacarrera/categorias" class="alert-link">Clic aquí</a>.
    </div>
  ...
  <div class="col-md-3">
     <label for="tip_ident">Tipo de Identificación</label>
     <select class="form-control" name="tip_ident" id="tip_ident">
      <option value="" selected="selected" >Seleccione Tipo idenficación</option>
      <option value="CC">Cédula</option>
      <option value="TI">Tarjeta Identidad</option>
      <option value="CE">Cedula Extranjera</option>
      <option value="PP">Pasaporte</option>
  </select>
  <?php echo form_error('tip_ident'); ?>
</div>-->
<div class="col-md-3">
 ...
 <?php echo form_error('numero_ident'); ?>
</div><!--
...
<div class="row">
    <div class="col-md-3">
     <label for="sexo" value="<?php echo set_value('sexo'); ?>">Sexo</label>
     <div class="radio">
...
<div class="col-md-3">
  ...
  <select class="form-control" name="tipo_sangre" id="tipo_sangre" value="<?php echo set_value('tipo_sangre'); ?>">
  ...
  <?php echo form_error('tipo_sangre'); ?>
</div>
<div class="col-md-3">
...
<br>
<button type="submit" name="enviar" id="enviar" class="btn btn-outline-success" onclick="javascript:enviarForm()">Enviar</button>
</form>
</div>  
</body>
</html>
