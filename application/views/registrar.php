  ...
  function enviarForm(){
    ...
    alert('datos serializados: '+dataString);
      ...
      $.ajax({
        ...
        error: function(){
          alert('Se ha presentado un error en la parametrización => funcion AJAX (enviarForm)');
        }
      });
      return false;
  }
    ...
    <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <label for="nombre" class="hidden-xs col-lg-2 control-label">Nombres</label>
                  <div class="col-lg-10">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="apellido" class="hidden-xs col-lg-2 control-label">Apellidos</label>
                  <div class="col-lg-10">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="sexo" class="hidden-xs col-lg-2 control-label">Tipo de Identificación</label>
                  <div class="col-lg-10">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label for="numero_ident" class="hidden-xs col-lg-2 control-label">Número de Idenficación</label>
                  <div class="col-lg-10">
...
font-weight: 700;" class="error" role="alert" return>El número de identificación ya existe</div>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
               <div class="form-group">
                <label for="tipo_sangre" class="hidden-xs col-lg-2 control-label">Tipo de sangre</label>
                <div class="col-lg-10">
            ...
            <div class="col-md-3">
             <div class="form-group">
              <label for="fecha_nac" class="hidden-xs col-lg-2 control-label">Fecha de Nacimiento</label>
              <div class="col-lg-10">
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="pais" class="hidden-xs col-lg-2 control-label">Pais</label>
            <div class="col-lg-10">
      ...
      <div class="row">
        <div class="col-md-3"><div class="form-group">
          <label for="ciudad" class="hidden-xs col-lg-2 control-label">Ciudad</label>
          <div class="col-lg-10">
     ...
     <div class="col-md-3"><div class="form-group">
      ...
      <label for="direccion" class="hidden-xs col-lg-2 control-label">Dirección</label>
      <div class="col-lg-10">
  ...
  <div class="col-md-3">
    <div class="form-group">
      <label for="barrio" class="hidden-xs col-lg-2 control-label">Barrio</label>
      <div class="col-lg-10">
 ...
 <div class="col-md-3">
  <div class="form-group">
  <label for="celular" class="hidden-xs col-lg-2 control-label">Celular</label>
    <div class="col-lg-10">
...
<div class="row">
  <div class="col-md-3">
      <div class="form-group">
      <label for="email" class="hidden-xs col-lg-2 control-label">Email</label>
      <div class="col-lg-10">
  ...
  <div class="col-md-3">
      <div class="form-group">
      <label for="conf_email" class="hidden-xs col-lg-2 control-label">Confirmar Email</label>
      <div class="col-lg-10">
